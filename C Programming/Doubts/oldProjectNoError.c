...
void billing()
{
    ...
    else
    {
        ...
        int exit;
        printf("\nEnter 1 to go back to main screen: ");
        scanf("%d", &exit);
...
void inventory()
{
    ...
    for (int i = 0; i < m; i++)
    {
        ...
        if (mens_stock[i] == 0)
        {
            printf("Product Code: %s\t", mens_code[i]);
    ...
    for (int i = 0; i < w; i++)
    {
        ...
        if (womens_stock[i] == 0)
        {
            printf("Product Code: %s\t", womens_code[i]);
    ...
    for (int i = 0; i < chi; i++)
    {
        if (child_stock[i] == 0)
        {
            printf("Product Code: %s\t", child_code[i]);
    ...
    if (j == 0)
    {
        printf("All items in stock\n");
    }
    else
    {
        printf("Items out of stock: %d", j);
    }
